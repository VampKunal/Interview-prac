...
public:
    virtual void startEngine() = 0; //abstraction layer
    virtual void shiftGear(int gear) = 0;// a car has these function but not declared yet 
...
*/
class SportsCar : public Car { //inheritence 
public:
    string brand;
    string model;
    bool isEngineOn;
